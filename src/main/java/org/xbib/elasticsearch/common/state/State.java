 ...
 */
package org.xbib.elasticsearch.common.state;
...
/**
 * A state represents a point in time when a task has a defined behavior
 */
public class State implements Streamable, ToXContent, Comparable<State> {
    ...
    public State setMap(Map<String, Object> map) {
        this.map = map;
        return this;
    }
    ...
    public State setStarted(DateTime started) {
     ...
     * @return this state
     */
    public State setLastActive(DateTime begin, DateTime end) {
    ...
    public State setCounter(Integer counter) {
    ...
    public State setCustom(Map<String, Object> custom) {
    ...
    public State setLastStartDate(long lastStartDate) {
    ...
    public State setLastEndDate(long lastEndDate) {
    ...
    public State setLastExecutionStartDate(long lastExecutionStartDate) {
    ...
    public State setLastExecutionEndDate(long lastExecutionEndDate) {
    ...
    public State fromXContent(XContentParser parser) throws IOException {
