...
public class PostRiverStateRequestBuilder extends AcknowledgedRequestBuilder<PostRiverStateRequest, PostRiverStateResponse, PostRiverStateRequestBuilder> {

    public PostRiverStateRequestBuilder(ClusterAdminClient client) {
        super((InternalGenericClient) client, new PostRiverStateRequest());
    }
    ...
    protected void doExecute(ActionListener<PostRiverStateResponse> listener) {
        ((ClusterAdminClient)client).execute(PostRiverStateAction.INSTANCE, request, listener);
    }
}