...
public class GetTaskAction extends ClusterAction<GetTaskRequest, GetTaskResponse, GetTaskRequestBuilder> {
    ...
    @Override
    public GetTaskRequestBuilder newRequestBuilder(ClusterAdminClient client) {
        return new GetTaskRequestBuilder(client);
    }
