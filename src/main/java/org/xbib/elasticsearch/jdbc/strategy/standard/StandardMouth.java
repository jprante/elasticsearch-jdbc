...
/**
 * Standard mouth implementation. This implementation uses bulk processing,
 ...
 */
public class StandardMouth<C extends StandardContext> implements Mouth<C> {
    ...
    @Override
    public StandardMouth<C> newInstance() {
        return new StandardMouth<C>();
    }

    @Override
    public StandardMouth<C> setContext(C context) {
        this.context = context;
        return this;
    }

    @Override
    public StandardMouth setIngestFactory(IngestFactory ingestFactory) {
    ...
    @Override
    public StandardMouth setIndexSettings(Settings indexSettings) {
        this.indexSettings = indexSettings;
        return this;
    }

    @Override
    public StandardMouth setTypeMapping(Map<String, String> typeMapping) {
        this.indexMappings = typeMapping;
        return this;
    }

    @Override
    public StandardMouth setIndex(String index) {
    ...
    @Override
    public StandardMouth setType(String type) {
        this.type = type;
        return this;
    }
    ...
    @Override
    public StandardMouth setId(String id) {
        this.id = id;
        return this;
    }
