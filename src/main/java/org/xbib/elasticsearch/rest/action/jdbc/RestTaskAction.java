...
import org.xbib.elasticsearch.action.jdbc.task.ExecuteTaskRequest;
import org.xbib.elasticsearch.action.jdbc.task.ExecuteTaskResponse;
...
public class RestTaskAction extends BaseRestHandler {
    ...
    @Inject
    public RestTaskAction(Settings settings, RestController controller, Client client) {
        super(settings, controller, client);

        controller.registerHandler(Method.POST, "/_jdbc/task/{name}", this);
    }
