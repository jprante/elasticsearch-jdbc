...
/**
 * Special {@link javax.net.ssl.SSLException} which will get thrown if a packet is
 * received that not looks like a TLS/SSL record. A user can check for
 * this {@link no.found.elasticsearch.transport.netty.ssl.NotSslRecordException} and so detect if one peer tries to
