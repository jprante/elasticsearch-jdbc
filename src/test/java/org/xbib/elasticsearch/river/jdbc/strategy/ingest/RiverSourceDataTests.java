...
public class RiverSourceDataTests extends AbstractRiverTest {

    private static final ESLogger logger = ESLoggerFactory.getLogger(RiverSourceDataTests.class.getName());
