...
public class RiverSourceTests extends AbstractRiverNodeTest {

    private static final ESLogger logger = ESLoggerFactory.getLogger(RiverSourceTests.class.getName());
