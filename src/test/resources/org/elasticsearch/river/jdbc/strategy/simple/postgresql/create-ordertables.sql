...
create table "orders" ("customer" varchar(32), "department" varchar(32), "product" varchar(32), "quantity" integer, "created" timestamp not null default '1970-01-01 00:00:00')
