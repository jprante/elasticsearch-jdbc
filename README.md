...
## Installation
    ...
    ./bin/plugin --install jdbc --url http://xbib.org/repository/org/xbib/elasticsearch/plugin/elasticsearch-river-jdbc/1.2.0.0/elasticsearch-river-jdbc-1.2.0.0-plugin.zip
