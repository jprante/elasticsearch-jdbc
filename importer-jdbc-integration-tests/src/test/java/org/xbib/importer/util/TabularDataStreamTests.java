...
import org.xbib.importer.elasticsearch.plugin.json.JsonPlugin;
 ...
 *
 */
public class TabularDataStreamTests extends Assert {
    ...
    public void testId() throws IOException {
        ...
        List<Object> row1 = Arrays.asList("index", "1", "label1");
        List<Object> row2 = Arrays.asList("index", "2", "label2");
        List<Object> row3 = Arrays.asList("index", "3", "label3");
        List<Object> row4 = Arrays.asList("index", "4", "label4");
        MockSink output = new MockSink();
        ElasticsearchDocumentBuilder builder = new ElasticsearchDocumentBuilder(output);
        builder.begin();
        builder.keys(columns);
        builder.values(row1);
        builder.values(row2);
        builder.values(row3);
        builder.values(row4);
    ...
    @Test
    public void testOptype() throws IOException {
        List<String> columns = Arrays.asList("_optype", "_id", "label");
        List<Object> row1 = Arrays.asList("index", "1", "label1");
        List<Object> row2 = Arrays.asList("create", "2", "label2");
        List<Object> row3 = Arrays.asList("delete", "3", "label3");
        List<Object> row4 = Arrays.asList("index", "4", "label4");
        MockSink output = new MockSink();
        ElasticsearchDocumentBuilder builder = new ElasticsearchDocumentBuilder(output);
        builder.begin();
    ...
    @Test
    public void testOverlappingOps() throws IOException {
        List<String> columns = Arrays.asList("_optype", "_id", "label");
        List<Object> row1 = Arrays.asList("index", "1", "label1");
        List<Object> row2 = Arrays.asList("create", "1", "label2");
        List<Object> row3 = Arrays.asList("delete", "2", "label3");
        List<Object> row4 = Arrays.asList("index", "2", "label4");
        MockSink output = new MockSink();
        ElasticsearchDocumentBuilder builder = new ElasticsearchDocumentBuilder(output);
        builder.begin();
        builder.keys(columns);
    ...
    public void testNestedObjects() throws IOException {
        ...
        List<Object> row1 = Arrays.asList("1", "$1000", "Joe Doe", "Worker", "2012-06-12");
        List<Object> row2 = Arrays.asList("2", "$2000", "Bill Smith", "Boss", "2012-06-13");
        MockSink output = new MockSink();
        ElasticsearchDocumentBuilder builder = new ElasticsearchDocumentBuilder(output);
        builder.begin();
        builder.keys(columns);
    ...
    public void testMultipleValues() throws IOException {
        List<String> columns = Arrays.asList("_id", "person.salary", "person.name", "person.position.name", "person.position.since");
        List<Object> row1 = Arrays.asList("1", "$1000", "Joe Doe", "Worker", "2012-06-12");
        List<Object> row2 = Arrays.asList("1", "$1000", "Joe Doe", "Worker", "2012-06-13");
        MockSink output = new MockSink();
        ElasticsearchDocumentBuilder builder = new ElasticsearchDocumentBuilder(output);
        builder.begin();
        builder.keys(columns);
    ...
    @Test
    public void testMultipleValuesWithNull() throws IOException {
        List<String> columns = Arrays.asList("_id", "person.salary", "person.name", "person.position.name", "person.position.since");
        List<Object> row1 = Arrays.asList("1", "$1000", "Joe Doe", "Worker", null);
        List<Object> row2 = Arrays.asList("1", "$1000", "Joe Doe", "Worker", "2012-06-13");
        MockSink output = new MockSink();
        ElasticsearchDocumentBuilder builder = new ElasticsearchDocumentBuilder(output);
        builder.begin();
    ...
    public void testSequenceValues() throws Exception {
        List<String> columns = Arrays.asList("_id", "person.salary", "person.name[]", "person.position.name", "person.position.since");
        List<Object> row1 = Arrays.asList("1", "$1000", "Joe,John", "Worker", null);
        List<Object> row2 = Arrays.asList("1", "$1000", "Mark", "Worker", "2012-06-13");
        List<Object> row3 = Arrays.asList("2", "$1000", "Mark", "Worker", "2012-06-13");
        MockSink output = new MockSink();
        ElasticsearchDocumentBuilder builder = new ElasticsearchDocumentBuilder(output);
        builder.begin();
        builder.keys(columns);
    ...
    public void testSequenceObjects() throws Exception {
        ...
        List<Object> row1 = Arrays.asList("1", "Andrew Ng", "Machine Learning", "5");
        List<Object> row2 = Arrays.asList("1", "Andrew Ng", "Recommender Systems", "5");
        List<Object> row3 = Arrays.asList("2", "Doug Cutting", "Hadoop Internals", "12");
        List<Object> row4 = Arrays.asList("2", "Doug Cutting", "Basic of Lucene", "25");
        List<Object> row5 = Arrays.asList("2", "Doug Cutting", "Advanced Lucene", "5");
        List<Object> row6 = Arrays.asList("2", "Doug Cutting", "Introduction to Apache Avro", "5");
        MockSink output = new MockSink();
        ElasticsearchDocumentBuilder builder = new ElasticsearchDocumentBuilder(output);
        builder.begin();
        builder.keys(columns);
    ...
    public void testJSONSource() throws Exception {
        ...
        List<Object> row1 = Arrays.asList("index", "1", "{\"Hello\":\"World\"}");
        MockSink output = new MockSink();
        ElasticsearchDocumentBuilder builder = new ElasticsearchDocumentBuilder(output);
        builder.begin();
        builder.keys(columns);
    ...
    public void testArrays() throws Exception {
        ...
        List<Object> row1 = Arrays.asList("4679", "Tesla, Abe and Elba", "2014-01-06 00:00:00", "3917", "Idris Elba", "9450", "/web/q/g/h/57436356.jpg");
        List<Object> row2 = Arrays.asList("4679", "Tesla, Abe and Elba", "2014-01-06 00:00:00", "3917", "Idris Elba", "9965", "/web/i/s/q/GS3193626.jpg");
        List<Object> row3 = Arrays.asList("4679", "Tesla, Abe and Elba", "2014-01-06 00:00:00", "3917", "Idris Elba", "9451", "/web/i/s/q/GS3193626.jpg");
        MockSink output = new MockSink();
        ElasticsearchDocumentBuilder builder = new ElasticsearchDocumentBuilder(output);
        builder.begin();
        builder.keys(columns);
    ...
    public void testNestedDots() throws Exception {
        ...
        List<Object> row1 = Arrays.asList("1", "Andrew Ng", "1", "Brian Smith");
        List<Object> row2 = Arrays.asList("1", "Andrew Ng", "2", "Marc Levengood");
        List<Object> row3 = Arrays.asList("2", "Doug Cutting", "1", "Brian Smith");
        List<Object> row4 = Arrays.asList("2", "Doug Cutting", "2", "Marc Levengood");
        List<Object> row5 = Arrays.asList("2", "Doug Cutting", "3", "Samantha Carter");
        List<Object> row6 = Arrays.asList("2", "Doug Cutting", "4", "Jack O'Neill");
        MockSink output = new MockSink();
        ElasticsearchDocumentBuilder builder = new ElasticsearchDocumentBuilder(output);
        builder.begin();
        builder.keys(columns);
    ...
    public void testIgnoreNullObject() throws Exception {
        ...
        row2.add("4015");
        row2.add("Jack");
        List<Object> row3 = new LinkedList<>();
        row3.add("4679");
        row3.add("Joe");
        row3.add(null);
        row3.add(null);
        ...
        builder.end();
        assertEquals(output.data().toString(),
                "{[null/null/null/4679]->{blog={name=\"Joe\", association=[{id=\"3917\", name=\"John\"}, {id=\"4015\", name=\"Jack\"}]}}={\"blog\":{\"name\":\"Joe\",\"association\":[{\"id\":\"3917\",\"name\":\"John\"},{\"id\":\"4015\",\"name\":\"Jack\"}]}}}"
        );
    }
    ...
    public void testIgnoreNullObject2() throws Exception {
        ...
        builder.end();
        assertEquals(output.data().toString(),
                "{[null/null/null/1]->{movie={event=21, title=\"ABC\", overview=\"DEF\", test=1212}}={\"movie\":{\"event\":21,\"title\":\"ABC\",\"overview\":\"DEF\",\"test\":1212}}}"
        );
    }
    ...
    public void testJSON() throws Exception {
        ...
        List<Object> row1 = Arrays.asList("index", "1", "{\"Hello\":\"World\"}", "{\"name\":[\"Joe\",\"John\"]}", "{\"haircolor\":\"blue\"}");
        MockSink output = new MockSink();
        ElasticsearchDocumentBuilder builder = new ElasticsearchDocumentBuilder(output);
        builder.addPlugin(new JsonPlugin());
        builder.begin();
        builder.keys(columns);
        builder.values(row1);
        builder.end();
    ...
    public void testJSONWithNull() throws Exception {
        List<String> columns = Arrays.asList("_optype", "_id", "message", "person", "person.attributes");
        List<Object> row1 = Arrays.asList("index", "1", "{\"Hello\":\"World\"}", "{\"name\":[\"Joe\",\"John\"]}", "{\"haircolor\":\"blue\"}");
        List<Object> row2 = Arrays.asList("index", "1", null, "{\"name\":[\"Joe\",\"John\"]}", "{\"haircolor\":\"blue\"}");
        MockSink output = new MockSink();
        ElasticsearchDocumentBuilder builder = new ElasticsearchDocumentBuilder(output);
        builder.addPlugin(new JsonPlugin());
        builder.begin();
